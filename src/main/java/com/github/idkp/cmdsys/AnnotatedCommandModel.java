...
import com.github.idkp.cmdsys.annotations.Branch;
import com.github.idkp.cmdsys.annotations.Command;
...
public final class AnnotatedCommandModel implements CommandModel {
    ...
    public AnnotatedCommandModel(Object command) {
        ...
        com.github.idkp.cmdsys.annotations.Command commandAnno = commandType.getAnnotation(Command.class);
